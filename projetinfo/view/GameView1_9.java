...
public class GameView1_9 extends View {
    private View myView;
    ...
    public GameView1_9(Context context) {
        super(context);
        init(null);
    }
    public GameView1_9(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);

        init(attrs);
    }
    public GameView1_9(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }
    public GameView1_9(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet set) {
        ...
        myView = findViewById(R.id.GameView1_9);
